...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ContactListsJsx = __webpack_require__(159);

	console.log(_ContactListsJsx.ContactsList);

	ReactDOM.render(React.createElement(_ContactListsJsx.ContactsList, null), document.getElementById("content"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AnimalsJsx = __webpack_require__(160);

	var _ClientsJsx = __webpack_require__(162);
	...
	var ContactsList = React.createClass({
	    ...
	    handleGetClient: function handleGetClient(animal) {
	        var displayedClients = CLIENTS.filter(function (el) {
	    ...
	    handleGetAnimal: function handleGetAnimal(client) {
	        var displayedAnimals = ANIMALS.filter(function (el) {
	    ...
	    render: function render() {
	        ...
	        var clientSelected = this.state.clientSelected;
	        var animalSelected = this.state.animalSelected;
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement('input', { type: 'text', className: 'form-control', onChange: this.handleSearch })
	            ),
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            this.state.displayedClients.map(function (el) {
	                                return React.createElement(_ClientsJsx.Clients, {
	                                    key: el.id,
	                                    name: el.name,
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            this.state.displayedAnimals.map(function (el) {
	                                return React.createElement(_AnimalsJsx.Animals, {
	                                    key: el.id,
	                                    name: el.name,
	                                    kind: el.kind,
	                                    breed: el.breed,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Animals = React.createClass({
	    ...
	    render: function render() {
	        var classname = (0, _classnames2['default'])({ 'success': this.props.selected });
	        return React.createElement(
	            'tr',
	            { className: classname, onClick: this.props.getClients },
	            React.createElement(
	                'td',
	                null,
	                this.props.name
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Clients = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            'tr',
	            { className: classname, onClick: this.props.getAnimal },
	            React.createElement(
	                'td',
	                null,
	                this.props.name
